...
const Slider3 = () => {
  return (
    ...
    <section className="main1 w-[95%] h-[700px] flex flex-row items-center px-20 bg-[#dadada] mt-24">
      ...
      <div className="right w-[35%] h-[100%] flex items-center justify-center">
        ...
        <div className="image w-[100%] h-[100%] items-center flex justify-end">
          <img className='w-[100%] h-[80%]' src={slide3} alt="" />
        </div>
